...
import com.daxode.odinbrains.common.ZigPathManager;
...
//            gdbBinaryPath = "bin/gdb.exe";
    ...
    private Properties msvcProperties() {
        val service = DownloadableFileService.getInstance();
        val desc = service.createFileDescription("https://falsepattern.com/odinbrains/msvc.properties", "msvc.properties");
