...
package com.daxode.odinbrains.project.openapi.module;

import com.daxode.odinbrains.project.ide.newproject.ZigModuleBuilder;
...
public class ZigModuleType extends ModuleType<ZigModuleBuilder> {
    ...
    public ZigModuleType() {
        super("com.daxode.odinbrains.zigModuleType");
    }
