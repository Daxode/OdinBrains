...
package com.daxode.odinbrains.project.util;
...
public class ElementUtil {
    ...
    public static void writeStrings(Element element, String name, String... values) {
        val arr = new Element("OdinBrainsArrayOption");
        arr.setAttribute("name", name);
        for (val value: values) {
            val subElem = new Element("OdinBrainsArrayEntry");
    ...
    public static Element writeChild(Element element, String name) {
        val child = new Element("OdinBrainsNestedOption");
